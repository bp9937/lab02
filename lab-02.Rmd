...
author: "Team Awesome Sauce: Annelise, Bosh, Pearse, Lachlan, Daniel, Jakob"
date: "`r Sys.Date()`"
...
# Region with most coastal countries -> Africa
...
plastic_data_all %>%
	group_by(region) %>%
  summarise(
      v = mean(total_mismanaged_plastic)) %>%
      arrange(desc(v))
     
# region with highest total mean is Aisa, lowest is Oceania
